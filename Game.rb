...
class Game
	attr_accessor :player_one, :player_two, :current_player, :game_over, :game_won, :game_tied, :board,:grid_size,:empty_cells
				...
				if @game_over==false		
					...
					if @game_over==false
						...
						if @game_over==false
							...
							if @game_over==false
								@game_over, @game_won=check_game_tied(board,grid_size,empty_cells)
							end
						end
					end
				end
...
def start()
	...
	game=Game.new(board,grid_size,empty_cells)
	game.play()
end
